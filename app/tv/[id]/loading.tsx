import { DetailBannerSkeleton, CastRowSkeleton } from "@/components/media/detail/MediaDetailSkeleton"
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {Array.from({ length: 4 }).map((_, i) => (
                            <div key={i} className="flex gap-4 p-4 rounded-xl bg-surface-2 animate-pulse">
