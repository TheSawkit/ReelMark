...
export default function PlaylistLoading() {
    return (
        <>
            <div className="relative -mt-16 min-h-[50vh] md:min-h-[55vh] flex flex-col justify-end bg-surface-2 animate-pulse">
                <div className="container mx-auto px-4 sm:px-6 lg:px-12 pt-28 md:pt-32 pb-8 md:pb-14 flex flex-col lg:flex-row lg:items-end gap-6 lg:gap-12">
                    <div className="flex-1 space-y-4 md:space-y-5">
                        <div className="flex gap-2">
                            <div className="h-8 w-32 rounded-full bg-surface-3" />
                        </div>
                        <div className="h-10 md:h-16 bg-surface-3 rounded-lg w-80 max-w-full" />
            ...
            <PageLayout className="pt-8 md:pt-12">
                <div className="h-4 w-24 bg-surface-3 rounded mb-4 md:mb-6 animate-pulse" />
