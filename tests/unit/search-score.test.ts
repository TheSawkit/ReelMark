...
function media(overrides: Partial<MediaItem> & { id: number; title: string }): MediaItem {
    return {
        media_type: "movie",
...
describe("rankMedia (2-tier exact + fuzzy)", () => {
    ...
    it("falls back to original_title when localized title diverges", () => {
        const items = [
            ...
            media({ id: 2, title: "Le Parrain", original_title: "The Godfather" }),
        ]
    ...
    it("places exact-substring 'harry potter' matches before fuzzy ones, ordered by popularity", () => {
        const items = [
            ...
            media({ id: 2, title: "Harry Potter and the Philosopher's Stone", popularity: 1500 }),
            media({ id: 3, title: "Harry Potter and the Chamber of Secrets", popularity: 1200 }),
        ]
