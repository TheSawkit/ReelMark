...
Database: the schema lives on the Supabase project (12 tables, RLS everywhere). To recreate it from scratch, follow [docs/DATA-MODEL.md](./DATA-MODEL.md) in the Supabase SQL Editor.
...
- **[docs/](./README.md)** — developer documentation: [architecture](./ARCHITECTURE.md) · [setup from scratch](./SETUP.md) · [data model](./DATA-MODEL.md) · [debugging](./DEBUGGING.md)
...
BDD : le schéma vit sur le projet Supabase (12 tables, RLS partout). Pour le recréer : [docs/DATA-MODEL.md](./DATA-MODEL.md).
...
- Docs : [`docs/`](./README.md) (architecture · setup · data model · debugging) · [`DEPLOYMENT.md`](../DEPLOYMENT.md) · [`SECURITY.md`](../SECURITY.md)
