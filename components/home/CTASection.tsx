...
export default async function CTASection({ lang }: { lang: Language }) {
	...
	return (
		<section className="px-6 py-24 lg:px-12">
			<div className="glass-surface relative mx-auto max-w-4xl overflow-hidden rounded-2xl border-glass-border-hover p-12 text-center shadow-card-lift md:p-16">
				...
				<div className="relative z-10">
					...
					<div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
						<Link
							...
							className="group/cta rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
						>
							<GlowBorder>
