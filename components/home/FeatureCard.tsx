...
export default function FeatureCard({
	...
	return (
		<div className="glass-surface h-full rounded-2xl p-8 transition-all duration-(--duration-base) ease-apple hover:-translate-y-1 hover:border-glass-border-hover hover:shadow-card-lift">
