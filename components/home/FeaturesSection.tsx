...
export default async function FeaturesSection() {
  ...
  const features = [
    {
      icon: <Film className="h-9 w-9 text-primary" />,
      title: t.features.feature1Title,
      description: t.features.feature1Desc,
    },
    {
      icon: <Compass className="h-9 w-9 text-gold" />,
      title: t.features.feature2Title,
      description: t.features.feature2Desc,
    },
    {
      icon: <FolderOpen className="h-9 w-9 text-primary" />,
      title: t.features.feature3Title,
      description: t.features.feature3Desc,
    },
    {
      icon: <Star className="h-9 w-9 text-gold" />,
    ...
    {
      icon: <Users className="h-9 w-9 text-gold" />,
    ...
    <section className="px-6 py-20 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <h2
          ...
          style={{
            animation: 'slideUpSubtle var(--duration-slower) ease-out both',
          }}
        >
