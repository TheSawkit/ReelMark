...
export function BottomTabBar({ username }: BottomTabBarProps) {
	...
	return (
		<nav className="fixed inset-x-0 bottom-0 z-50 lg:hidden bottom-nav-safe-area">
			...
			/>
			<div className="glass-bar relative mx-4 mb-3 flex h-16 items-center justify-around rounded-(--radius-banner) border border-border-subtle px-1.5 shadow-navbar">
