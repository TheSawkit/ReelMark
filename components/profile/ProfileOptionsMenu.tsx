...
export function ProfileOptionsMenu({ targetUserId, friendship }: ProfileOptionsMenuProps) {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon-sm" aria-label={t.profile.friendOptions} disabled={isPending}>
            ...
            <DropdownMenuContent align="start">
                {localFriendship?.status === 'accepted' && (
                    <>
                        <DropdownMenuItem variant="destructive" onClick={handleRemove} disabled={isPending}>
