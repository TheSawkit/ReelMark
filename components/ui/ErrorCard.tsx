...
export function ErrorCard({ reset, icon: Icon = AlertTriangle, backHref = "/explorer" }: ErrorCardProps) {
    const { t } = useTranslation()
    const backLabel = backHref === "/dashboard" ? t.common.errorBackHome : t.common.backToExplorer
