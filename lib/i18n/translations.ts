export const translations = {
    fr: {
        ...
        features: {
            ...
            feature5Desc: "Installez ReelMark sur iPhone, Android, Mac, Windows ou Linux — sans passer par un store, comme une app native.",
            feature6Title: 'Amis & communauté',
            feature6Desc: "Suivez les critiques et listes de vos amis, envoyez des demandes d'amis et découvrez ce que regardent les autres.",
        },
        explorer: {
            title: 'Explorateur',
            ...
            matchingMovies: 'Nous avons trouvé {count} résultats correspondants.',
        ...
        settings: {
            ...
            social: {
                ...
                description: 'Ajoutez vos liens pour les afficher sur votre profil',
                bio: 'Bio',
            ...
            avatar: {
                ...
                invalidExtension: 'Extension invalide — jpg, jpeg, png ou webp uniquement',
            ...
            data: {
                ...
                exportDescription: 'Télécharge toutes tes données (watchlist, avis, épisodes vus) au format JSON.',
                exportButton: 'Exporter',
                exportSuccess: 'Export téléchargé',
                importTitle: 'Importer des données',
                importDescription: 'Importe ton historique depuis Letterboxd, Trakt ou un export ReelMark.',
        ...
        profile: {
            ...
            friendsOnlyDesc: 'Tu dois être ami avec cet utilisateur pour voir ce contenu',
            ...
            deletePlaylistConfirmDesc: 'Tous les films et séries ajoutés seront perdus. Cette action est irréversible.',
        ...
        auth: {
            ...
            resetPassword: {
                ...
                metaDescription: 'Recevez un lien pour réinitialiser votre mot de passe ReelMark.',
                title: 'Réinitialiser votre mot de passe',
                description: 'Entrez votre adresse e-mail. Nous vous enverrons un lien de réinitialisation.',
                email: 'E-mail',
                button: 'Envoyer le lien',
                backToLogin: 'Retour à la connexion',
                successTitle: 'E-mail envoyé',
                successDescription: 'Si un compte existe pour cette adresse, vous recevrez un e-mail avec un lien.',
                placeholders: {
                    email: 'chuck@example.com',
                },
            },
            updatePassword: {
                ...
                metaDescription: 'Définissez un nouveau mot de passe pour votre compte ReelMark.',
                title: 'Choisir un nouveau mot de passe',
                description: 'Entrez votre nouveau mot de passe pour finaliser la réinitialisation.',
                password: 'Nouveau mot de passe',
                confirmPassword: 'Confirmer le mot de passe',
                button: 'Mettre à jour',
                note: 'Vous serez redirigé vers votre tableau de bord après la mise à jour.',
                footerHint: 'Si le lien a expiré, demandez un nouveau lien depuis la page de connexion.',
                placeholders: {
                    password: '••••••••',
                    confirmPassword: '••••••••',
                },
        ...
        metadata: {
            ...
            libraryDescription: 'Votre bibliothèque personnelle de films et séries à regarder ou déjà vus.',
    ...
    en: {
        ...
        features: {
            ...
            feature5Desc: 'Install ReelMark on iPhone, Android, Mac, Windows or Linux — no app store required, just like a native app.',
            feature6Title: 'Friends & Community',
            feature6Desc: "Follow friends' reviews and watchlists, send friend requests, and discover what others are watching.",
        },
        explorer: {
            title: 'Explorer',
            overview: 'Overview',
        ...
        settings: {
            ...
            social: {
                ...
                errors: {
                    ...
                    letterboxdTooLong: 'Letterboxd handle must be 50 characters or less',
            ...
            data: {
                ...
                exportDescription: 'Download all your data (watchlist, reviews, watched episodes) as JSON.',
                exportButton: 'Export',
                exportSuccess: 'Export downloaded',
                importTitle: 'Import Data',
                importDescription: 'Import your history from Letterboxd, Trakt, or a ReelMark export.',
        ...
        profile: {
            ...
            deletePlaylistConfirmDesc: 'All added movies and shows will be lost. This action cannot be undone.',
        ...
        auth: {
            ...
            resetPassword: {
                ...
                successDescription: 'If an account exists for this address, you will receive an email with a link.',
                placeholders: {
                    email: 'chuck@example.com',
                },
            },
            updatePassword: {
                ...
                footerHint: 'If the link expired, request a new one from the login page.',
                placeholders: {
                    password: '••••••••',
                    confirmPassword: '••••••••',
                },
        ...
        metadata: {
            ...
            libraryDescription: 'Your personal library of movies and TV shows to watch or already seen.',
            loginTitle: 'Log in',
