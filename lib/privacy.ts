...
export const VALID_VISIBILITY = new Set<PrivacyVisibility>(['public', 'friends', 'private'])

export function isVisibility(v: unknown): v is PrivacyVisibility {
    return typeof v === 'string' && VALID_VISIBILITY.has(v as PrivacyVisibility)
}

export function parseVisibility(v: unknown, fallback: PrivacyVisibility = 'private'): PrivacyVisibility {
